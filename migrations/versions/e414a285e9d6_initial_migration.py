...
Revision ID: e414a285e9d6
Revises: 
Create Date: 2026-03-01 18:20:03.720478
...
def upgrade():
    ...
    sa.UniqueConstraint('full_name', 'street', 'city', 'postal_code', 'country', name='full_address')
    )
